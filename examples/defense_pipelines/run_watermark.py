...
import torch
from amulet.defenses import WatermarkNN
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('--wm_path', type = str, default = '../../data/trigger_set/', help = 'trigger sets.')
    parser.add_argument('--gray', type = bool, default = 0, help = 'Options: 0 for cifar10, 1 for fmnist, only for cifar10 and fmnist.')
    parser.add_argument('--tabular', type = bool, default = 0, help = 'Options: 0 for cifar10, fmnist, 1 for lfw, census.')
    parser.add_argument('--shape', type = bool, default = 0, help = 'Options: 0 for cifar10, fmnist, 1 for lfw, census.')
...
def main(args: argparse.Namespace) -> None:
    ...
    logging.basicConfig(level=logging.INFO, 
                        filename=log_dir / 'watermarking.log', 
                        filemode="w")
    ...
    # Train or load model with Watermarking  
    defended_model_path = models_path / 'watermarking' 
    ...
    if defended_model_filename.exists():
        ...
        wm_model = WatermarkNN(target_model,
                                           criterion,
                                           optimizer,
                                           train_loader,
                                           args.device,
