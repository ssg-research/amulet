...
def main(args: argparse.Namespace) -> None:
    ...
    discr_behavior = DiscriminatoryBehavior(target_model, test_loader_wsattr, args.device)
    ...
    discr_behavior = DiscriminatoryBehavior(defended_model, test_loader_wsattr, args.device)
    subgroup_accuracies = discr_behavior.evaluate_subgroup_metrics()
