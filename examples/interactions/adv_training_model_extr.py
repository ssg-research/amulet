...
def main(args: argparse.Namespace) -> None:
    ...
    logging.basicConfig(level=logging.INFO, 
                        filename=log_dir / 'adversarial_training_model_extraction.log', 
                        filemode="w")
    ...
    defended_model_path = models_path / 'adversarial_training' / f'epsilon_{args.epsilon}' / 'defendedForExtraction' / f'adv_train_fraction_{args.adv_train_fraction}'
